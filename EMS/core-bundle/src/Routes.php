...
class Routes
{
    final public const EMSCO_ADMIN_CONTENT_TYPE_UPDATE_FROM_JSON = 'emsco_admin_content_type_update_from_json';
    final public const EMSCO_ADMIN_CONTENT_TYPE_REMOVE = 'emsco_admin_content_type_remove';
    final public const EMSCO_ADMIN_CONTENT_TYPE_ACTIVATE = 'emsco_admin_content_type_activate';
    final public const EMSCO_ADMIN_CONTENT_TYPE_DEACTIVATE = 'emsco_admin_content_type_deactivate';
    final public const EMSCO_ADMIN_CONTENT_TYPE_REFRESH_MAPPING = 'emsco_admin_content_type_refresh_mapping';
    final public const EMSCO_ADMIN_CONTENT_TYPE_ADD = 'emsco_admin_content_type_add';
    final public const EMSCO_ADMIN_CONTENT_TYPE_INDEX = 'emsco_admin_content_type_index';
    final public const EMSCO_ADMIN_CONTENT_TYPE_UNREFERENCED = 'emsco_admin_content_type_unreferenced';
    final public const EMSCO_ADMIN_CONTENT_TYPE_FIELD_EDIT = 'emsco_admin_content_type_field_edit';
    final public const EMSCO_ADMIN_CONTENT_TYPE_REORDER = 'emsco_admin_content_type_reorder';
    final public const EMSCO_ADMIN_CONTENT_TYPE_EDIT = 'emsco_admin_content_type_edit';
    final public const EMSCO_ADMIN_CONTENT_TYPE_STRUCTURE = 'emsco_admin_content_type_structure';
    final public const EMSCO_ADMIN_CONTENT_TYPE_EXPORT = 'emsco_admin_content_type_export';
