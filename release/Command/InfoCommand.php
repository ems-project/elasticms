...
class InfoCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $style->table(['Step', 'Description', 'Command'], [
            ['<info>Step 1</info>', 'release packages', '<comment>github:release:packages 5.x 5.2.0 5.0.1</comment>'],
            ...
            ['<info>Step 4</info>', 'commit composer.lock files', '<error>no command for now</error>'],
            ['<info>Step 5</info>', 'release admin/web/cli', '<comment>github:release:applications 5.x 5.2.0 5.0.1</comment>'],
            ['<info>Step 6</info>', 'release docker admin/web/cli', '<comment>github:release:docker 5.x 5.2.0 5.0.1</comment>'],
        ]);
