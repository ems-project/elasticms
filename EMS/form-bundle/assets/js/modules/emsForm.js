...
export const DEFAULT_CONFIG = {
    ...
    ouuid: false,
    onLoad: function () {
        console.log('ems-form loaded')
    },
    onSubmit: function () {
        console.log('ems-form submit')
    },
    onResponse: function (response) {
        console.log('ems-form response: ', response.toString())
    },
    onConfirmationResponse: function (response) {
        console.log('ems-form confirmation: ', response)
    },
    onError: function (message) {
        console.log('ems-form error: ' + message)
    }
}
...
export class emsForm {
    ...
    isValid() {
        return (
            this.elementIframe !== null && this.elementForm !== null && this.elementMessage !== null
        )
    }
    ...
    onMessage(e) {
        ...
        switch (data.instruction) {
            ...
            case 'dynamic':
                replaceFormFields(
                    data.response,
                    Object.values(encoding.jsonParse(data.dynamicFields))
                )
