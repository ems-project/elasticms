...
//           const $li = this.item
//           const hasCollapsedClass = $li.hasClass(self.options.collapsedClass)
//           const hasExpandedClass = $li.hasClass(self.options.expandedClass)
//
...
//       (function () {
//         const _parentItem = this.placeholder.parent().parent()
...
//       (function () {
//         const _previousItem = this.placeholder.prev()
...
//       (function () {
//         const _nextItem = this.placeholder.next()
//         if (_nextItem.length) {
//           nextItem = _nextItem
//         } else {
//           nextItem = null
...
//       const half = this.options.isTree ? 0.8 : 0.5
//       const isOverBottomHalf = isOverAxis(
//         this.positionAbs.top + this.offset.click.top,
//         item.top + (item.height * half),
//         item.height
//       )
//       const isOverTopHalf = isOverAxis(
//         this.positionAbs.top + this.offset.click.top,
//         item.top - (item.height * half),
//         item.height
//       )
//       const isOverRightHalf = isOverAxis(
...
//         const pid = ($(o.item || this).parent(o.listType)
//           .parent(o.items)
//           .attr(o.attribute || 'id') || '')
//           .match(o.expression || (/(.+)[-=_](.+)/))
//
...
//
//       const o = this.options
//       const childrenList = $(item).children(o.listType)
