...
export class UploadAdapter {
    ...
    _start(fileHandler) {
        ...
        this.fileUploader = new FileUploader({
            ...
            onProgress: (status, progress, remaining) =>
                this._progress(status, progress, remaining),
            onUploaded: (assetUrl, previewUrl) =>
                this._uploaded(assetUrl, previewUrl),
    ...
    _error(message, code) {
        console.log(
            `Couldn't upload file: ${this.loader.file.name} with return code ${code}.`,
        );
        console.log(message);
        this.reject(message);
    }
