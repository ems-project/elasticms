    ...
    _enableEnterHandling() {
        ...
        enterCommand.on("execute", () => {
            ...
            const rangeToCheck = model.createRangeIn(
                position.parent.previousSibling,
            );
