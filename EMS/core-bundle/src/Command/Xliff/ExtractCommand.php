...
final class ExtractCommand extends AbstractCommand
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addArgument(self::ARGUMENT_FIELDS, InputArgument::IS_ARRAY, 'List of content type\s fields to extract. Use the pattern %locale% if required. Use the . to separate nested fields from its parent and # to access a field that is JSON encoded in its parent. e.g. fr.content#title')
