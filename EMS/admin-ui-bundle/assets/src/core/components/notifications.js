...
class Notifications {
    ...
    updateCounter() {
        const numberOfElem =
            document.querySelectorAll("ul#activity-log>li").length;
        document.getElementById("activity-counter").innerHTML =
            numberOfElem === 0 ? "" : numberOfElem;
    }
