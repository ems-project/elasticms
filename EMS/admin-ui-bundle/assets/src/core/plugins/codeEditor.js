...
export default class CodeEditor {
    ...
    loadEditors(target) {
        ...
        for (let i = 0; i < codeEditors.length; i++) {
            ...
            let maxLines = 15;
            if (
                hiddenField.data("max-lines") &&
                hiddenField.data("max-lines") > 0
            ) {
            ...
            let minLines = 1;
            if (
                hiddenField.data("min-lines") &&
                hiddenField.data("min-lines") > 0
            ) {
