...
class FileController extends AbstractController
{
    ...
    public function assetInArchive(Request $request, string $hash, string $path, int $maxAge = 604800, bool $extract = true): Response
    {
        $this->closeSession($request);

        return $this->processor->getResponseFromArchive($request, $hash, $path, $maxAge, $extract);
    }
