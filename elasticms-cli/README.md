...
the Composer dependencies in a base-php builder container, then the `prd` and
...
| Variable | Effect |
|----------|--------|
| `HTTP_PROXY`, `HTTPS_PROXY`, `NO_PROXY` (and lower case) | Passed to the image build and to the Composer containers. |
