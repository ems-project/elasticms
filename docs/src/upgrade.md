...
- BC: media library template no longer relies on Bootstrap classes or Font Awesome icons by default,
  make sure to update the template. The file link now is not required to have the json attribute.
