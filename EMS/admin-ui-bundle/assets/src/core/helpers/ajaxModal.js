...
class AjaxModal {
    constructor(selector) {
        ...
        this.onKeyDown = (event) => {
            ...
            const btnAjaxSubmit =
                this.modal.querySelector("#ajax-modal-submit");
            const blockTargetElements = [
                "textarea",
                "input",
                "select",
                "button",
            ...
            if (
                btnAjaxSubmit &&
                !Array.from(blockTargetElements).includes(
    ...
    ajaxReady(json, url, callback) {
        ...
        const messages = Object.hasOwn(json, "modalMessages")
            ? json.modalMessages
            : [];
        messages.forEach((m) => {
