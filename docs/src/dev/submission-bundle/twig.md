...
Fetch ems_submission.connection key/value information (usefull to hide credentials from
DB/Elasticsearch): The string passed to the filter should be in the format
...
This function can be called in the message twig temple in order to bypass the current handler
